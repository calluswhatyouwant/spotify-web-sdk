...
Object.defineProperty(exports, "__esModule", { value: true });
var external_url_1 = __importDefault(__webpack_require__(1));
...
Object.defineProperty(exports, "__esModule", { value: true });
var album_simplified_1 = __importDefault(__webpack_require__(40));
var artist_simplified_1 = __importDefault(__webpack_require__(4));
var external_id_1 = __importDefault(__webpack_require__(13));
var external_url_1 = __importDefault(__webpack_require__(1));
var Track = (function () {
    function Track(json) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var external_url_1 = __importDefault(__webpack_require__(1));
var followers_1 = __importDefault(__webpack_require__(7));
...
var external_url_1 = __importDefault(__webpack_require__(1));
var image_1 = __importDefault(__webpack_require__(3));
var paging_1 = __importDefault(__webpack_require__(16));
var Album = (function () {
    function Album(json) {
...
var track_1 = __importDefault(__webpack_require__(6));
exports.getSeveralTracks = function (ids) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, driver_1.getAxiosSpotifyInstance().get('/tracks', params)];
            case 1:
                response = _a.sent();
                return [2, response.data.tracks.map(function (trackJson) { return new track_1.default(trackJson); })];
        }
    });
}); };
exports.getTrack = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [2, new track_1.default(response.data)];
        }
    });
}); };
...
Object.defineProperty(exports, "__esModule", { value: true });
var driver_1 = __webpack_require__(2);
var artist_1 = __importDefault(__webpack_require__(14));
    ...
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    return [2, response.data.artists.items.map(function (artistJson) { return new artist_1.default(artistJson); })];
            }
        });
    });
};
...
var driver_1 = __webpack_require__(2);
var artist_1 = __importDefault(__webpack_require__(14));
var album_1 = __importDefault(__webpack_require__(15));
var track_1 = __importDefault(__webpack_require__(6));
exports.getArtist = function (id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [2, new artist_1.default(response.data)];
        }
    });
}); };
exports.getSeveralArtists = function (ids) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [2, response.data.artists.map(function (artistJson) { return new artist_1.default(artistJson); })];
        }
    });
}); };
exports.getArtistAlbums = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, driver_1.getAxiosSpotifyInstance().get("/artists/" + id + "/albums")];
            case 1:
                response = _a.sent();
                return [2, response.data.items.map(function (albumJson) { return new album_1.default(albumJson); })];
        }
    });
}); };
exports.getRelatedArtists = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
exports.getArtistTopTracks = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, driver_1.getAxiosSpotifyInstance().get("/artists/" + id + "/top-tracks")];
            case 1:
                response = _a.sent();
                return [2, response.data.tracks.map(function (trackJson) { return new track_1.default(trackJson); })];
        }
...
var driver_1 = __webpack_require__(2);
var album_1 = __importDefault(__webpack_require__(15));
var track_simplified_1 = __importDefault(__webpack_require__(44));
exports.getAlbum = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, driver_1.getAxiosSpotifyInstance().get("/albums/" + id)];
            case 1:
                response = _a.sent();
                return [2, new album_1.default(response.data)];
        }
    });
}); };
exports.getSeveralAlbums = function (ids) { return __awaiter(_this, void 0, void 0, function () {
    var exceptionLink, params, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                response = _a.sent();
                return [2, response.data.artists.map(function (albumJson) { return new album_1.default(albumJson); })];
        }
    });
}); };
exports.getAlbumTracks = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, driver_1.getAxiosSpotifyInstance().get("/albums/" + id + "/tracks")];
            case 1:
                response = _a.sent();
                return [2, response.data.items.map(function (trackJson) { return new track_simplified_1.default(trackJson); })];
        }
    });
}); };
...
Object.defineProperty(exports, "__esModule", { value: true });
var driver_1 = __webpack_require__(2);
var playlist_1 = __importDefault(__webpack_require__(46));
var playlist_track_1 = __importDefault(__webpack_require__(47));
exports.getPlaylist = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, driver_1.getAxiosSpotifyInstance().get("/plylists/" + id)];
            case 1:
                response = _a.sent();
                return [2, new playlist_1.default(response.data)];
        }
    });
}); };
exports.getPlaylistTracks = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, driver_1.getAxiosSpotifyInstance().get("/playlists/" + id + "/tracks")];
            case 1:
                response = _a.sent();
                return [2, response.data.items.map(function (trackJson) { return new playlist_track_1.default(trackJson); })];
        }
    });
}); };
exports.getUserPlaylists = function (id) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, driver_1.getAxiosSpotifyInstance().get("/users/" + id + "/playlists")];
            case 1:
                response = _a.sent();
                return [2, response.data.items.map(function (playlistJson) { return new playlist_1.default(playlistJson); })];
        }
    });
}); };
...
var image_1 = __importDefault(__webpack_require__(3));
var paging_1 = __importDefault(__webpack_require__(16));
var user_public_1 = __importDefault(__webpack_require__(17));
