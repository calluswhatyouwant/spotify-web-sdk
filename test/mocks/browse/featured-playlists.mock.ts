export const featuredPlaylistsMock = {
    message: 'Monday morning music, coming right up!',
    playlists: {
        href:
            'https://api.spotify.com/v1/browse/featured-playlists?country=SE&offset=0&limit=2',
        items: [
            {
                collaborative: false,
                external_urls: {
        ...
        limit: 2,
        next:
            'https://api.spotify.com/v1/browse/featured-playlists?country=SE&offset=2&limit=2',
        offset: 0,
        previous: null,
        total: 12,
    },
